...
private struct BadgeCell: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ZStack {
                Circle()
                    .fill(unlocked ? theme.accentColor.opacity(0.15) : theme.secondaryTextColor.opacity(0.06))
            ...
            Text(id.title)
                ...
                .foregroundStyle(unlocked ? theme.primaryTextColor : theme.secondaryTextColor.opacity(0.5))
        ...
        .background(
            RoundedRectangle(cornerRadius: 10)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 10)
                        .strokeBorder(unlocked ? theme.accentColor.opacity(0.25) : theme.secondaryTextColor.opacity(0.1), lineWidth: 1)
                )
        )
    }
}
